...
public class SearchResultsTest extends BaseTest {
	...
	public void TC02_verifyResultsURLContainsKeyword() {
		...
		Assert.assertTrue(driver.getCurrentUrl().toLowerCase().contains("python"), "URL does not contain keyword");
	}
	...
	public void TC04_verifyFirstCourseCardVisible() {
		...
		Assert.assertTrue(resultsPage.getCourseCount() > 0, "No course cards visible");
	}
	...
	public void TC05_verifyClickFirstCourseNavigatesToDetailPage() {
		...
		Assert.assertTrue(driver.getCurrentUrl().contains("course"), "Did not navigate to course page");
	}
	...
	public void TC06_verifyNoCrashForInvalidKeyword() {
		...
		Assert.assertTrue(driver.getCurrentUrl().contains("udemy"), "Page crashed for invalid input");
	}
	...
	public void TC07_verifyNoCrashForNumericInput() {
		...
		Assert.assertTrue(driver.getCurrentUrl().contains("udemy"), "Page crashed for numeric input");
	}
	...
	public void TC08_verifyNoCrashForSpecialCharacters() {
		...
		Assert.assertTrue(driver.getCurrentUrl().contains("udemy"), "Page crashed for special characters");
	}
	...
	public void TC09_verifyResultsPageURLNotEmpty() {
		...
		Assert.assertFalse(driver.getCurrentUrl().isEmpty(), "URL is empty");
	}
